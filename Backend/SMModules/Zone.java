...
public class Zone {
    ...
    private void adjustRoomTemperaturesToTarget() {
        for (Room room : rooms) {
            // Here you might add logic to only adjust temperature if the room is occupied
            // or based on other conditions
    ...
    public void simulateEnvironmentalChanges(double externalFactor) {
        // Simulate changes in room temperatures due to external factors (e.g., weather
        // changes)
        for (Room room : rooms) {
